...
function getAgaveAccessToken(consumerKey, consumerSecret, username){
    ...
    $.ajax({
      type: "POST",
      url: "https://agaveauth.its.hawaii.edu:443/token",
      dataType: 'json',
      async: false,
      headers: {
...
function getStorageDirectoryListing(system_id, file_path){
    ...
    $.ajax({
      type: "GET",
      url: "https://agaveauth.its.hawaii.edu:443/files/v2/listings/system/"+system_id+"/"+file_path,
      dataType: 'json',
      async: false,
      headers: {
...
function getJobListing(system_id){
    $.ajax({
      type: "GET",
      url: "https://agaveauth.its.hawaii.edu:443/jobs/v2/",
      dataType: 'json',
      async: false,
